function eniplac(;verbose=false, solver=nothing)
    ...
    @constraint(m, e33,-(601.56+0.0131* (x[1])^2+1.0622*x[1])*x[25]+x[73]==0.0)
    @constraint(m, e34,-(10.04286*x[2]-0.01048* (x[2])^2-92.8095)*x[26]+x[74]==0.0)
    @constraint(m, e35,-(657.32+0.018317* (x[3])^2)*x[27]+x[75]==0.0)
    @constraint(m, e36,-(222.2+0.0001* (x[4])^2+6.2749*x[4])*x[28]+x[76]==0.0)
    @constraint(m, e37,-(601.56+0.0131* (x[5])^2+1.0622*x[5])*x[29]+x[77]==0.0)
    @constraint(m, e38,-(10.04286*x[6]-0.01048* (x[6])^2-92.8095)*x[30]+x[78]==0.0)
    @constraint(m, e39,-(657.32+0.018317* (x[7])^2)*x[31]+x[79]==0.0)
    @constraint(m, e40,-(222.2+0.0001* (x[8])^2+6.2749*x[8])*x[32]+x[80]==0.0)
    @constraint(m, e41,-(601.56+0.0131* (x[9])^2+1.0622*x[9])*x[33]+x[81]==0.0)
    @constraint(m, e42,-(10.04286*x[10]-0.01048* (x[10])^2-92.8095)*x[34]+x[82]==0.0)
    @constraint(m, e43,-(657.32+0.018317* (x[11])^2)*x[35]+x[83]==0.0)
    @constraint(m, e44,-(222.2+0.0001* (x[12])^2+6.2749*x[12])*x[36]+x[84]==0.0)
    @constraint(m, e45,-(601.56+0.0131* (x[13])^2+1.0622*x[13])*x[37]+x[85]==0.0)
    @constraint(m, e46,-(10.04286*x[14]-0.01048* (x[14])^2-92.8095)*x[38]+x[86]==0.0)
    @constraint(m, e47,-(657.32+0.018317* (x[15])^2)*x[39]+x[87]==0.0)
    @constraint(m, e48,-(222.2+0.0001* (x[16])^2+6.2749*x[16])*x[40]+x[88]==0.0)
    @constraint(m, e49,-(601.56+0.0131* (x[17])^2+1.0622*x[17])*x[41]+x[89]==0.0)
    @constraint(m, e50,-(10.04286*x[18]-0.01048* (x[18])^2-92.8095)*x[42]+x[90]==0.0)
    @constraint(m, e51,-(657.32+0.018317* (x[19])^2)*x[43]+x[91]==0.0)
    @constraint(m, e52,-(222.2+0.0001* (x[20])^2+6.2749*x[20])*x[44]+x[92]==0.0)
    @constraint(m, e53,-(601.56+0.0131* (x[21])^2+1.0622*x[21])*x[45]+x[93]==0.0)
    @constraint(m, e54,-(10.04286*x[22]-0.01048* (x[22])^2-92.8095)*x[46]+x[94]==0.0)
    @constraint(m, e55,-(657.32+0.018317* (x[23])^2)*x[47]+x[95]==0.0)
    @constraint(m, e56,-(222.2+0.0001* (x[24])^2+6.2749*x[24])*x[48]+x[96]==0.0)
