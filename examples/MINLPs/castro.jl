function castro2m2(; solver = nothing)
    ...
    @constraint(
        m,
        e27,
        0.01 * x[16] + 0.01 * x[18] + 0.01 * x[24] + 0.01 * x[26] - x[28] ==
        0.0
    )
    @constraint(
        m,
...
function castro6m2(; solver = nothing)
    ...
    @constraint(
        m,
        e5,
        -x[1] - x[4] - x[7] - x[16] - x[19] - x[22] + x[26] == 0.0
    )
    @constraint(
        m,
        e6,
        -x[2] - x[5] - x[8] - x[17] - x[20] - x[23] + x[27] == 0.0
    )
    @constraint(
        m,
        e7,
        -x[3] - x[6] - x[9] - x[18] - x[21] - x[24] + x[28] == 0.0
    )
    ...
    @constraint(
        m,
        e11,
        -x[10] - x[11] - x[12] - x[13] - x[14] - x[15] + x[25] == 0.0
    )
    ...
    @constraint(
        m,
        e81,
        x[29] + x[38] + x[47] + x[74] + x[83] + x[92] - x[101] == 0.0
    )
    @constraint(
        m,
        e82,
    ...
    @constraint(
        m,
        e83,
        x[31] + x[40] + x[49] + x[76] + x[85] + x[94] - x[103] == 0.0
    )
    @constraint(
        m,
        e84,
    ...
    @constraint(
        m,
        e88,
        x[36] + x[45] + x[54] + x[81] + x[90] + x[99] - x[108] == 0.0
    )
    @constraint(
        m,
        e89,
...
function castro4m2(; solver = nothing)
    ...
    @constraint(
        m,
        e37,
        0.05 * x[16] + 0.05 * x[20] + 0.05 * x[32] + 0.05 * x[36] - x[40] ==
        0.0
    )
    ...
    @constraint(
        m,
        e40,
        0.024 * x[19] + 0.024 * x[23] + 0.024 * x[35] + 0.024 * x[39] - x[43] ==
        0.0
    )
