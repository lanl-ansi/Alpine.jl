function ex1225a(; solver = nothing)
    ...
    @NLconstraint(
        m,
        e5,
        (-0.00023593220338983 * x[4] * x[10]) - 629 * (0.000338983050847458 * x[4])^2 +
        0.0116 * (x[10])^2 +
        x[7] == 0.0
    )
    @NLconstraint(
    ...
    @NLconstraint(
        m,
        e7,
        (-0.000179661016949153 * x[6] * x[12]) - 361 * (0.000338983050847458 * x[6])^2 +
        0.00946 * (x[12])^2 +
        x[9] == 0.0
    )
...
function ex1264a(; solver = nothing)
    ...
    @constraint(
        m,
        e1,
        -0.1 * b[17] - 0.2 * b[18] - 0.3 * b[19] - 0.4 * b[20] - i[21] - i[22] - i[23] -
        i[24] + objvar == 0.0
    )
    ...
    @constraint(
        m,
        e6,
        -330 * i[1] - 360 * i[5] - 385 * i[9] - 415 * i[13] + 1700 * b[17] <= 0.0
    )
    @constraint(
        m,
        e7,
        -330 * i[2] - 360 * i[6] - 385 * i[10] - 415 * i[14] + 1700 * b[18] <= 0.0
    )
    @constraint(
        m,
        e8,
        -330 * i[3] - 360 * i[7] - 385 * i[11] - 415 * i[15] + 1700 * b[19] <= 0.0
    )
    @constraint(
        m,
        e9,
        -330 * i[4] - 360 * i[8] - 385 * i[12] - 415 * i[16] + 1700 * b[20] <= 0.0
    )
    @constraint(
        m,
        e10,
        330 * i[1] + 360 * i[5] + 385 * i[9] + 415 * i[13] - 1900 * b[17] <= 0.0
    )
    @constraint(
        m,
        e11,
        330 * i[2] + 360 * i[6] + 385 * i[10] + 415 * i[14] - 1900 * b[18] <= 0.0
    )
    @constraint(
        m,
        e12,
        330 * i[3] + 360 * i[7] + 385 * i[11] + 415 * i[15] - 1900 * b[19] <= 0.0
    )
    @constraint(
        m,
        e13,
        330 * i[4] + 360 * i[8] + 385 * i[12] + 415 * i[16] - 1900 * b[20] <= 0.0
    )
...
function prob10(; solver = nothing)
    ...
    @NLconstraint(
        m,
        e3,
        1.1 * ((2 * x[2] - 10)^2 + (i[3] - 5)^2) + sin((2 * x[2] - 10)^2 + (i[3] - 5)^2) -
        objvar == 0.0
    )
...
function st_miqp2(; solver = nothing)
    ...
    @NLconstraint(
        m,
        e4,
        -(4 * i[3]^2 - 3 * i[3] + 2 * i[4]^2 - 10 * i[4]) - 4 * i[1] - 5 * i[2] +
        objvar == 0.0
    )
...
function st_miqp4(; solver = nothing)
    ...
    @NLconstraint(
        m,
        e5,
        -(5 * x[4]^2 + 2 * x[4] + 5 * x[5]^2 + 3 * x[5] + 10 * x[6]^2 - 500 * x[6]) -
...
function st_miqp5(; solver = nothing)
    ...
    @constraint(
        ...
        0.291729982996 * x[6] - 0.222506183367 * x[7] <= 0.0
    )
    @constraint(
        m,
        e4,
    ...
    @constraint(
        m,
        e10,
        -i[1] + 0.0524800119769 * x[3] + 0.904837825133 * x[4] - 0.209520819817 * x[5] +
        0.291729982996 * x[6] +
    ...
    @constraint(
        m,
        e12,
        -i[2] - 0.445391966818 * x[3] - 0.301519984248 * x[4] - 0.587645368916 * x[5] +
        0.145864991498 * x[6] +
        0.586607210695 * x[7] <= 0.0
    )
    @constraint(
    ...
    @NLconstraint(
        m,
        e14,
        -(5 * x[6]^2 - 0.875189948987 * x[6] + 52 * x[7]^2 - 192.710582631 * x[7]) +
        54.0615511462 * x[3] +
        45.2691026456 * x[4] +
        33.0896119339 * x[5] +
        objvar == 0.0
