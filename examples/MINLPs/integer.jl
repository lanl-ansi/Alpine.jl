function ex1225a(; solver = nothing)
    ...
    @NLconstraint(
        ...
        e1,
        -(
            (6329.03 + 1800 * x[1]) * i[16] * i[19] * b[22] +
            (2489.31 + 1800 * x[2]) * i[17] * i[20] * b[23] +
            (3270.27 + 1800 * x[3]) * i[18] * i[21] * b[24]
        ) + objvar == 0.0
    )
    @NLconstraint(
        m,
        e2,
        (-19.9 * (0.000338983050847458 * x[4])^3) -
        0.161 * (0.000338983050847458 * x[4])^2 * x[10] +
        1.90169491525424e-7 * x[4] * (x[10])^2 +
        x[1] == 0.0
    )
    @NLconstraint(
        m,
        e3,
        (-1.21 * (0.000338983050847458 * x[5])^3) -
        0.0644 * (0.000338983050847458 * x[5])^2 * x[11] +
        1.91186440677966e-7 * x[5] * (x[11])^2 +
        x[2] == 0.0
    )
    @NLconstraint(
        m,
        e4,
        (-6.52 * (0.000338983050847458 * x[6])^3) -
        0.102 * (0.000338983050847458 * x[6])^2 * x[12] +
        7.86440677966102e-8 * x[6] * (x[12])^2 +
        x[3] == 0.0
    )
    @NLconstraint(
        m,
        e5,
        (-0.00023593220338983 * x[4] * x[10]) -
        629 * (0.000338983050847458 * x[4])^2 +
        0.0116 * (x[10])^2 +
        x[7] == 0.0
    )
    @NLconstraint(
        m,
        e6,
        (-0.001 * x[5] * x[11]) - 215 * (0.000338983050847458 * x[5])^2 +
        0.115 * (x[11])^2 +
        x[8] == 0.0
    )
    @NLconstraint(
        m,
        e7,
        (-0.000179661016949153 * x[6] * x[12]) -
        361 * (0.000338983050847458 * x[6])^2 +
        0.00946 * (x[12])^2 +
        x[9] == 0.0
    )
...
function ex1264a(; solver = nothing)
    ...
    @constraint(
        m,
        e1,
        -0.1 * b[17] - 0.2 * b[18] - 0.3 * b[19] - 0.4 * b[20] - i[21] - i[22] -
        i[23] - i[24] + objvar == 0.0
    )
    @NLconstraint(
        m,
        e2,
        i[21] * i[1] + i[22] * i[2] + i[23] * i[3] + i[24] * i[4] >= 9.0
    )
    @NLconstraint(
        m,
        e3,
        i[21] * i[5] + i[22] * i[6] + i[23] * i[7] + i[24] * i[8] >= 7.0
    )
    @NLconstraint(
        m,
        e4,
        i[21] * i[9] + i[22] * i[10] + i[23] * i[11] + i[24] * i[12] >= 12.0
    )
    @NLconstraint(
        m,
        e5,
        i[21] * i[13] + i[22] * i[14] + i[23] * i[15] + i[24] * i[16] >= 11.0
    )
    @constraint(
        m,
        e6,
        -330 * i[1] - 360 * i[5] - 385 * i[9] - 415 * i[13] + 1700 * b[17] <=
        0.0
    )
    @constraint(
        m,
        e7,
        -330 * i[2] - 360 * i[6] - 385 * i[10] - 415 * i[14] + 1700 * b[18] <=
        0.0
    )
    @constraint(
        m,
        e8,
        -330 * i[3] - 360 * i[7] - 385 * i[11] - 415 * i[15] + 1700 * b[19] <=
        0.0
    )
    @constraint(
        m,
        e9,
        -330 * i[4] - 360 * i[8] - 385 * i[12] - 415 * i[16] + 1700 * b[20] <=
        0.0
    )
    @constraint(
        m,
        e10,
        330 * i[1] + 360 * i[5] + 385 * i[9] + 415 * i[13] - 1900 * b[17] <=
        0.0
    )
    @constraint(
        m,
        e11,
        330 * i[2] + 360 * i[6] + 385 * i[10] + 415 * i[14] - 1900 * b[18] <=
        0.0
    )
    @constraint(
        m,
        e12,
        330 * i[3] + 360 * i[7] + 385 * i[11] + 415 * i[15] - 1900 * b[19] <=
        0.0
    )
    @constraint(
        m,
        e13,
        330 * i[4] + 360 * i[8] + 385 * i[12] + 415 * i[16] - 1900 * b[20] <=
        0.0
    )
...
function prob10(; solver = nothing)
    ...
    @NLconstraint(
        m,
        e3,
        1.1 * ((2 * x[2] - 10)^2 + (i[3] - 5)^2) +
        sin((2 * x[2] - 10)^2 + (i[3] - 5)^2) - objvar == 0.0
    )
...
function st_miqp1(; solver = nothing)
    ...
    @constraint(
        m,
        e1,
        20 * i[1] + 12 * i[2] + 11 * i[3] + 7 * i[4] + 4 * i[5] >= 40.0
    )
    @NLconstraint(
        m,
        e2,
...
function st_miqp2(; solver = nothing)
    ...
    @NLconstraint(
        m,
        e4,
        -(4 * i[3]^2 - 3 * i[3] + 2 * i[4]^2 - 10 * i[4]) - 4 * i[1] -
        5 * i[2] + objvar == 0.0
    )
...
function st_miqp4(; solver = nothing)
    ...
    @NLconstraint(
        ...
        e5,
        -(
            5 * x[4]^2 + 2 * x[4] + 5 * x[5]^2 + 3 * x[5] + 10 * x[6]^2 -
            500 * x[6]
        ) - 10 * i[1] + 4 * i[2] - 5 * i[3] + objvar == 0.0
    )
...
function st_miqp5(; solver = nothing)
    ...
    @constraint(
        ...
        2.89695789508 * x[5] +
        0.729324957489 * x[6] +
        3.8837442915 * x[7] <= 60.0
    )
    @constraint(
        m,
        e2,
        -1.13150591228 * x[3] + 1.10500971967 * x[4] - 1.01838569726 * x[5] +
        2.62556984696 * x[6] +
        4.85468036438 * x[7] <= 60.0
    )
    @constraint(
        m,
        e3,
        -0.0524800119769 * x[3] - 0.904837825133 * x[4] +
        0.209520819817 * x[5] - 0.291729982996 * x[6] - 0.222506183367 * x[7] <=
        0.0
    )
    @constraint(
        m,
        e4,
        0.0524800119769 * x[3] + 0.904837825133 * x[4] - 0.209520819817 * x[5] +
        0.291729982996 * x[6] +
        0.222506183367 * x[7] <= 1.0
    )
    @constraint(
        m,
        e5,
        0.445391966818 * x[3] + 0.301519984248 * x[4] + 0.587645368916 * x[5] -
        0.145864991498 * x[6] - 0.586607210695 * x[7] <= 0.0
    )
    @constraint(
        m,
        e6,
        -0.445391966818 * x[3] - 0.301519984248 * x[4] - 0.587645368916 * x[5] +
        0.145864991498 * x[6] +
        0.586607210695 * x[7] <= 1.0
    )
    @constraint(
        m,
        e7,
        -0.328188665272 * x[3] + 0.199986646277 * x[4] + 0.506106406938 * x[5] -
        0.583459965992 * x[6] + 0.505695871289 * x[7] >= 0.0
    )
    @constraint(
        m,
        e8,
        -0.345682002598 * x[3] - 0.101625962101 * x[4] +
        0.57594668021 * x[5] +
        0.729324957489 * x[6] +
        0.0809113394063 * x[7] >= 0.0
    )
    @constraint(
        m,
        e9,
        0.756087294764 * x[3] - 0.200079270407 * x[4] +
        0.151379235251 * x[5] +
        0.145864991498 * x[6] +
        0.586607210695 * x[7] >= 0.0
    )
    @constraint(
        m,
        e10,
        -i[1] + 0.0524800119769 * x[3] + 0.904837825133 * x[4] -
        0.209520819817 * x[5] +
        0.291729982996 * x[6] +
        0.222506183367 * x[7] <= 0.0
    )
    @constraint(
        m,
        e11,
    ...
    @constraint(
        m,
        e12,
        -i[2] - 0.445391966818 * x[3] - 0.301519984248 * x[4] -
        0.587645368916 * x[5] +
        0.145864991498 * x[6] +
        0.586607210695 * x[7] <= 0.0
    )
    @constraint(
        ...
        0.445391966818 * x[3] +
        0.301519984248 * x[4] +
        0.587645368916 * x[5] - 0.145864991498 * x[6] - 0.586607210695 * x[7] <=
        0.0
    )
    @NLconstraint(
        m,
        e14,
        -(
            5 * x[6]^2 - 0.875189948987 * x[6] + 52 * x[7]^2 -
            192.710582631 * x[7]
        ) +
        54.0615511462 * x[3] +
        45.2691026456 * x[4] +
