...
include("logging.jl")
include("nl_expr/expr_type_checking.jl")
include("nl_expr/nl_expr_utilities.jl")
include("fbbt/fbbt_utilities.jl")
include("fbbt/fbbt.jl")
include("fbbt/dag.jl")
include("fbbt/redundancy.jl")
include("models/continuous_relaxation.jl")
include("convexity_detection/convexity_helper.jl")
include("convexity_detection/convexity.jl")
include("convexity_detection/quadratic.jl")
include("convexity_detection/convexity_propagation.jl")
include("convexity_detection/populate_convexity.jl")
include("inits.jl")
include("user_functions.jl")
include("algorithm/local_solver.jl")
include("algorithm/presolver.jl")
