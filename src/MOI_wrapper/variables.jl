"""
The MOI_wrapper/variables.jl file contains all information 
on the supported variable types for Alpine.jl with its 
...
""" 
Primal-start support for Alpine (not supported)
"""
