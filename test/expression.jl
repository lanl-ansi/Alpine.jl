...
@testset "Expression Parsing || bilinear || Affine || exprs.jl" begin
    ...
    test_solver = AlpineSolver(nlp_solver=IpoptSolver(print_level=0, sb="yes"),mip_solver=CBC,loglevel=100)
...
@testset "Expression Parsing || bilinear || Complex || blend029.jl " begin
    ...
    test_solver = AlpineSolver(minlp_solver=pavito_solver,mip_solver=CBC,loglevel=100)
...
@testset "Expression Parsing || part1 " begin
    m = Model(solver=AlpineSolver(nlp_solver=IpoptSolver(print_level=0, sb="yes"),mip_solver=CBC,loglevel=100))
    @variable(m, x[1:4]>=0)
...
@testset "Expression Parsing || Discrete Multilinear" begin
    ...
    @testset "Expression Parsing || bmpl && binlin && binprod" begin
        ...
        test_solver=AlpineSolver(minlp_solver=pavito_solver,nlp_solver=IpoptSolver(print_level=0, sb="yes"),mip_solver=CBC,loglevel=100)
...
@testset "Expression Parsing || sin/cos" begin
    @testset "Expression Parsing || sin/cos || specialopts " begin
        ...
        test_solver=AlpineSolver(minlp_solver=pavito_solver,nlp_solver=IpoptSolver(print_level=0), mip_solver=CBC,loglevel=100)
